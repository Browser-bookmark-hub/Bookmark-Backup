...
<table>
  <tr>
    <td><img src="../../Screenshots and icons/v2.1/v2.0_main_ui.png" alt="扩展主界面 (中文, 暗色主题)"></td>
    <td><img src="../../Screenshots and icons/v2.1/v1.5.png" alt="扩展主界面 (英文, 亮色主题)"></td>
  </tr>
  <tr>
    <td><img src="../../Screenshots and icons/v2.1/v2.0_setting.png" alt="动态提醒设置界面 (中文, 暗色主题)"></td>
    <td><img src="../../Screenshots and icons/v2.1/notification.png" alt="备份提醒通知 (中文, 暗色主题)"></td>
  </tr>
</table>
...
<table>
  <tr>
    <td><img src="../../Screenshots and icons/v2.1/main_ui.png" alt="Extension Main UI (Chinese, Dark Theme)"></td>
    <td><img src="../../Screenshots and icons/v2.1/v1.5.png" alt="Extension Main UI (English, Light Theme)"></td>
  </tr>
  <tr>
    <td><img src="../../Screenshots and icons/v2.1/setting.png" alt="Reminder Settings UI (Chinese, Dark Theme)"></td>
    <td><img src="../../Screenshots and icons/v2.1/notification.png" alt="Notification UI (Chinese, Dark Theme)"></td>
  </tr>
</table>
